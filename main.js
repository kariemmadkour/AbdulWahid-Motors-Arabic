...
const T = {
  en: {
    ...
    'fin1.f1':           'Up to EGP 75M financing',
    ...
    'contact.address':   'Sheikh Zayed City, Cairo, Egypt',
    'contact.phone':     'Phone',
    'contact.hours':     'Hours',
    'contact.hoursval':  'Sun–Thu: 10AM–10PM · Fri–Sat: 12PM–10PM',
    ...
    'footer.copy':       '© 2025 AbdulWahid Motors Egypt. All rights reserved.',
  ...
  ar: {
    ...
    'hero.sub':          'مركبات فاخرة مختارة بعناية. أداء لا مثيل له. الفرق الذي يصنعه عبدالواحد موتورز.',
    ...
    'fin1.f1':           'تمويل يصل إلى 75 مليون جنيه',
    ...
    'contact.address':   'مدينة الشيخ زايد، القاهرة، مصر',
    'contact.phone':     'الهاتف',
    'contact.hours':     'أوقات العمل',
    'contact.hoursval':  'الأحد–الخميس: 10ص–10م · الجمعة–السبت: 12م–10م',
    ...
    'footer.copy':       '© 2025 عبدالواحد موتورز مصر. جميع الحقوق محفوظة.',
